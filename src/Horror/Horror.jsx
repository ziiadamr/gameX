...
useEffect(() => {
  // GET request
axios.get('https://api.allorigins.win/raw?url=https://www.freetogame.com/api/games?category=horror')
      .then(response => {
    ...
    return (
        ...
        <Helmet>
         ...
         <div className='py-20 mt-4 z-50 relative'>
          ...
          <h2 className=' text-custom text-3xl font-extrabold '>Horror gameX</h2>
          <p className='text-base font-semibold pt-4 mb-20 max-w-md text-mute'>Top Free Horror Games for PC and Browser In 2025!
          <br/>10 free-to-play Horror games found in our games list!
</p>
          </div>
