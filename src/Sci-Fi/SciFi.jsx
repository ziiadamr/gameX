...
function SciFi() {
  ...
  useEffect(() => {
      // GET request
  axios.get('https://api.allorigins.win/raw?url=https://www.freetogame.com/api/games?category=sci-fi')
          .then(response => {
  ...
  if (error) {
    ...
    return (
        ...
        <Helmet>
          ...
          <h2 className=' text-custom text-3xl font-extrabold '>Sci-Fi gameX</h2>
          <p className='text-base font-semibold pt-4 mb-20 max-w-md text-mute'>Top Free Sci-Fi Games for PC and Browser In 2025!
          <br/>72 free-to-play Sci-Fi games found in our games list!
</p>
          </div>
