...
function Sports() {
  ...
  useEffect(() => {
    // GET request
axios.get('https://api.allorigins.win/raw?url=https://www.freetogame.com/api/games?category=sports')
        .then(response => {
  ...
  return (
    ...
    return (
        ...
        <Helmet>
          ...
          <h2 className=' text-custom text-3xl font-extrabold '>Sports gameX</h2>
          <p className='text-base font-semibold pt-4 mb-20 max-w-md text-mute'>Top Free Sports Games for PC and Browser In 2025!
          <br/>13 free-to-play Sports games found in our games list!
</p>
          </div>
