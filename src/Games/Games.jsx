...
function Games() {
    ...
    useEffect(() => {
        // GET request
    axios.get('https://api.allorigins.win/raw?url=https://www.freetogame.com/api/games')
            .then(response => {
    ...
    return (
        <>
        <Helmet>
          <title>All gameX</title>
        </Helmet>
            <div className='py-20 mt-4 z-50 relative'>
          <div className='container mx-auto text-center flex flex-col items-center'>
          <h2 className=' text-custom text-3xl font-extrabold '>All gameX</h2>
          <p className='text-base font-semibold pt-4 mb-20 max-w-md text-mute'>Top Free Games for PC and Browser In 2025!
          <br/>404 free-to-play games found in our games list!
</p>
          </div>
