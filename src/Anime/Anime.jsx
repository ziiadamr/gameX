...
function Anime() {
  ...
  useEffect(() => {
    // GET request
axios.get('https://api.allorigins.win/raw?url=https://www.freetogame.com/api/games?category=anime')
        .then(response => {
  ...
  return (
    ...
    return (
        ...
        <Helmet>
          ...
          <h2 className=' text-custom text-3xl font-extrabold '>Anime gameX</h2>
          <p className='text-base font-semibold pt-4 mb-20 max-w-md text-mute'>Top Free Anime Games for PC and Browser In 2025!
          <br/>74 free-to-play Anime games found in our games list!
</p>
          </div>
